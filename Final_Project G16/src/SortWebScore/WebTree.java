...
public class WebTree {
	...
	public void setPostOrderScore(List<Keyword> keywordList) throws IOException{
		setPostOrderScore(root, keywordList);
	}
	
	private void setPostOrderScore(WebNode startNode, List<Keyword> keywords) throws IOException{
